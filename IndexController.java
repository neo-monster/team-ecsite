...
import jp.co.internous.duo.model.domain.MstCategory;
import jp.co.internous.duo.model.domain.MstProduct;
import jp.co.internous.duo.model.form.SearchForm;
import jp.co.internous.duo.model.mapper.MstCategoryMapper;
import jp.co.internous.duo.model.mapper.MstProductMapper;
...
public class IndexController {
	...
	public String index(Model m) {
		...
		if (!loginSession.getLoginFlg() && loginSession.getTmpUserId() == 0) {
